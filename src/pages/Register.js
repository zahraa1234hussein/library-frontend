...
export default function Register() {
  ...
  async function register() {
    dispatch(startRegister({name, email, password, cPassword, userType: 'CLIENT', phoneNumber}, history))
  }
      ...
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            />
            {error.name.localeCompare("phoneNumber") === 0 && <Typography color="error">{error.message}</Typography>}
            <TextField
